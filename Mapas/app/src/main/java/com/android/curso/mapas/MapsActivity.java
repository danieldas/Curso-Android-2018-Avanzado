package com.android.curso.mapas;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng plaza = new LatLng(-17.969787119708023, -67.11475725398327);
        mMap.addMarker(new MarkerOptions().position(plaza).title("Plaza 10 de febrero")
